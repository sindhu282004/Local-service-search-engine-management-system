					...
					<div class="col-md-12 col-sm-6 col-xs-12"><!-- category column -->
						<div class="cat-wrap shadow-1">
							...
							<div class="cat-list-wrap">
								<ul class="cat-list">
									<?php
$sql="SELECT Category, count(ID) as total,Picture from tblcategory group by Category";
...
{               ?>
									<li><a href="view-category-detail.php?viewid=<?php echo htmlentities ($row->Category);?>"><?php  echo htmlentities($row->Category);?> <img src="admin/images/<?php echo $row->Picture; ?>" width="200" height="200"><span>(<?php  echo htmlentities($row->total);?>)</span></a></li>
									<?php $cnt=$cnt+1;}}
									echo " ".$row->Picture; ?>
