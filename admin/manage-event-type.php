...
if($_GET['del']){
$pid=$_GET['id'];
$sql="delete from tblServicetype where ID ='$pid'";
...
{               ?>
     ...
     <a href="manage-event-type.php?id=<?php echo $row->ID;?>&del=delete"  onclick="return confirm('Do you really want to Delete ?');" class="btn btn-danger">Delete</a>
                  </td>
