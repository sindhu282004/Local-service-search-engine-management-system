          ...
          <?php include_once('includes/header.php');?>
            ...
            <main id="main-container">
                ...
                <div class="content">
                    ...
                    <!-- Register Forms -->
                    <h2 class="content-heading"><h3>Between Dates Report</h3></h2>
                    <div class="row">
                        <div class="col-md-12">
                            <!-- Bootstrap Register -->
                                ...
                                <div class="block-content">
                                    ...
                                    <form method="post" name="bwdatesreport" action="booking-bwdates-reports-details.php">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-12" for="register1-email"><h4>From Date:</h4></label>
                                            <div class="col-12">
                                                 <input type="date" class="form-control" id="fromdate" name="fromdate" value="" required='true'>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-12" for="register1-email"><h4>To Date:</h4></label>
                                            <div class="col-12">
