                            ...
                            <div class="content-header-section text-center align-parent sidebar-mini-hidden">
                                ...
                                <div class="content-header-item">
                                    <a class="link-effect font-w700" href="dashboard.php">
                                        ...
                                        <span class="font-size-xl text-dual-primary-dark">LSSEMS</span>|<span class="font-size-xl text-primary">ADMIN</span>
                                    </a>
                                </div>
                                <!-- END Logo -->
                            </div>
...
{               ?>
                        ...
                        <div class="content-side content-side-full">
                            <ul class="nav-main">
                                ...
                                <li>
                                    <a class="nav-submenu" data-toggle="nav-submenu" href="#"><i class="si si-energy"></i><span class="sidebar-mini-hide">Person List</span></a>
                                    <ul>
                                        <li>
                                            <a href="add-event-type.php">Add Person List</a>
                                        </li>
                                        <li>
                                            <a href="manage-event-type.php">Manage Person List</a>
                                        </li>
