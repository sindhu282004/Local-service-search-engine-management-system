          ...
          <?php include_once('includes/header.php');?>
            ...
            <main id="main-container">
                ...
                <div class="content">
                    ...
                    <!-- Register Forms -->
                    <h1 class="content-heading">Update Contact Us</h1>
                    <div class="row">
                        <div class="col-md-12">
                            <!-- Bootstrap Register -->
...
{               ?>        
                                        ...
                                        <div class="form-group row">
                                            <label class="col-12" for="register1-email"><h4>Page Description:</h4></label>
                                            <div class="col-12">
