...
{               ?>
							<STRONG style="color: blue"><h1><?php  echo $row->PageTitle;?></h1></STRONG>
							<STRONG style="color: black"><h3><p style="padding-right: 50px"><?php  echo $row->PageDescription;?></p></h3></STRONG>
						</div><?php $cnt=$cnt+1;}} ?>
						<div class="col-xs-12 col-sm-8 col-md-8 col-lg-8"><!-- .pricing -->
							<div class="pricing shadow-1 clearfix">
								<img src="images/about.png" height="350" width="600" alt="" />
							</div>
						</div><!-- pricing end -->
