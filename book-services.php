...
$sql="insert into tblbooking(BookingID,ServiceID,UserID,BookingDate,ServiceType,Message,cityName)values(:bookingid,:bid,:uid,:bookingdate,:servicetype,:message,:cityname)";
					...
					<div class="agileinfo-contact-form-grid">
						<form method="post">
							 <div class="form-group row">
                                    ...
                                    <div class="col-md-10">
                                        <input type="date" class="form-control" style="font-size: 20px" required="true" name="bookingdate">
                                    </div>
                                </div>
...
<option value="<?php echo htmlentities($row->Servicename);?>"><?php echo htmlentities($row->Servicename);?></option>
 <?php } ?>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-10">
                                        <input type="text" class="form-control" style="font-size: 20px" required="true" name=>
                                    </div>
                                </div>
